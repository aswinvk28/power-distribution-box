...
class Container extends React.Component {
    ...
    constructor(props) {
        ...
        const boxes = [
            ...
            size: {width: '42px', height: '45px'}, distribution_name: "cartesian", description: 'PILOT LIGHTS', breaker: {  },
            bbox: [0,0,0,0] },
            ...
            size: {width: '42px', height: '45px'}, distribution_name: "templated", description: '125A CEE 400V 5P', breaker: {  },
            bbox: [0,0,0,0] },
        ];
        const distributions = [
